...
- `add-guide`: create SEO guide/blog articles in `src/data/guides`, including Medium-style Learn SQL companion posts that cross-reference lesson routes and related guides
