...
export default function ChartExportBar({ chartRef }: ChartExportBarProps) {
  ...
  return (
    <div className="flex items-center gap-1 border-t border-slate-200 bg-slate-50/80 px-2 py-1 dark:border-slate-800 dark:bg-slate-900/80">
      <span className="mr-1 select-none text-[10px] text-slate-400 dark:text-slate-500">Export:</span>

      <button
        onClick={handleExportSVG}
        className="flex items-center gap-1 rounded px-2 py-1 text-[11px] font-medium text-slate-600 transition-colors hover:bg-blue-50 hover:text-blue-700 dark:text-slate-300 dark:hover:bg-blue-500/10 dark:hover:text-blue-300"
