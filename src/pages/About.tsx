  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-4">
        <div className="text-center">
          ...
          <p className="text-xl sm:text-2xl text-slate-600 mb-8 max-w-3xl mx-auto">
            ...
            <span className="font-semibold text-green-600">100% locally</span>{" "}
            in your browser
          </p>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16">
        <h2 className="text-5xl sm:text-5xl font-bold text-center text-slate-900 mb-12">
          Powerful Features
        </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-slate-200/50 p-6 hover:shadow-xl transition-shadow">
            ...
            <p className="text-slate-600">
              All processing happens in your browser. Your files never touch a
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-slate-200/50 p-6 hover:shadow-xl transition-shadow">
            ...
            <p className="text-slate-600">
              Query CSV, JSON, and Parquet files with the same powerful SQL
              syntax. Mix and match formats in joins.
            </p>
          </div>
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-slate-200/50 p-6 hover:shadow-xl transition-shadow">
            ...
            <p className="text-slate-600">
              Powered by DuckDB WASM for blazing-fast in-memory processing.
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-slate-200/50 p-6 hover:shadow-xl transition-shadow">
            ...
            <p className="text-slate-600">
              Modern SQL editor with syntax highlighting, auto-completion, and
              intelligent suggestions powered by Monaco.
            </p>
          </div>
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-slate-200/50 p-6 hover:shadow-xl transition-shadow">
            ...
            <p className="text-slate-600">
              Use complex queries, joins, aggregations, window functions, and
              everything you expect from a modern SQL engine.
            </p>
          </div>
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-slate-200/50 p-6 hover:shadow-xl transition-shadow">
            ...
            <p className="text-slate-600">
              No installation, no configuration, no servers. Just open your
              browser and start querying your data immediately.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-3xl shadow-2xl p-8 sm:p-12 relative overflow-hidden">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <div className="space-y-4 text-white/95 text-lg">
                  ...
                  <p className="leading-relaxed">
                    ...
                    Ask your favorite AI to generate the SQL query, then run it
                    securely in SQL for Files. Your data{" "}
                    <span className="font-bold underline decoration-2 decoration-yellow-300">
                      never leaves your device
                    </span>{" "}
                    — you stay compliant and don't share your data with any
                    service.
                  </p>
                  <div className="bg-white/15 backdrop-blur-sm border-2 border-white/30 rounded-xl p-5 mt-6">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-white/90">
                          Use your AI-powered SQL assistance while maintaining
